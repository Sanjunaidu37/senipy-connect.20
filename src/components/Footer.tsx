...
const Footer = () => {
  return (
    <footer className="bg-gray-50 border-t border-border pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-1">
            <Link to="/" className="text-xl font-bold text-foreground tracking-tight flex items-center mb-4">
              <span className="text-primary">Senipy</span>
            </Link>
            <p className="text-muted-foreground mb-4">
              Making technology accessible and enjoyable for elderly users with intuitive features.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">Voice Integration</Link></li>
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">Health Monitoring</Link></li>
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">Interactive Games</Link></li>
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">Voice Shopping</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">User Guides</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/#" className="text-muted-foreground hover:text-primary transition-colors">News</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Senipy. All rights reserved.
            </p>
